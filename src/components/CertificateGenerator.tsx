...
export function CertificateGenerator() {
  ...
  const handleExportPDF = async () => {
    ...
    try {
      ...
      doc.addFont("Garamond-normal.ttf", "Cormorant Garamond", "normal");
      doc.addFont("Garamond-normal.ttf", "CormorantGaramond", "normal");

      doc.addFileToVFS("Garamond-italic.ttf", garamondItalicBase64);
      doc.addFont("Garamond-italic.ttf", "Garamond", "italic");
      doc.addFont("Garamond-italic.ttf", "Cormorant Garamond", "italic");
      doc.addFont("Garamond-italic.ttf", "CormorantGaramond", "italic");
